...
# warning-ignore:return_value_discarded
	...
	for ThrowingSpear in $ThrowingSpears.get_children():
		ThrowingSpear.set_owner(self)
...
func _reset_attack():
	...
	_anim_tree.set_condition("SpearAttack" , false )

func _reset_move():
	_anim_tree.set_condition("SpearThrow" , false )
